...
public class ChatServerGUI extends JFrame implements ActionListener {
    ...
    public ChatServerGUI() {
        ...
        Head.add(header = new JLabel("Server Chating..."), BorderLayout.NORTH);
        ...
        try {
            Thread.sleep(1000);
            main.append("Selamat Datang di WinzChat Ver 1.0 Beta, \n");
    ...
    public class threadclient extends Thread {
        ...
        public void run() {
            try {
                ...
                pw.println("Selamat Datang di WinzChat");
